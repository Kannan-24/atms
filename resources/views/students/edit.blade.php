                    ...
                    <div class="mb-4">
                        ...
                        <select name="batch_id" id="batch_id"
                            ...
                            @foreach($batches as $batch)
                                <option value="{{ $batch->id }}" {{ $student->batch_id == $batch->id ? 'selected' : '' }}>{{ $batch->start_year }} - {{ $batch->end_year }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="dept_id" id="dept_id"
                            ...
                            @foreach($departments as $department)
                                <option value="{{ $department->id }}" {{ $student->dept_id == $department->id ? 'selected' : '' }}>{{ $department->dept_name }} - {{ $department->dept_code }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="class_id" id="class_id"
                            ...
                            @foreach($classes as $class)
                                <option value="{{ $class->id }}" {{ $student->class_id == $class->id ? 'selected' : '' }}>{{ $class->department->dept_code }} - {{ $class->section }}</option>
                            @endforeach
                        </select>
                    </div>
