            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('departments.index') }}"
                        class="flex items-center p-2 rounded-lg transition-transform duration-300 ease-in-out transform 
                    {{ request()->routeIs('departments.*') ? 'bg-blue-500 text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-500 dark:hover:text-blue-400' }}">
