<x-app-layout>
    ...
    <x-slot name="title">
        {{ __('Edit Batch') }} - {{ config('app.name', 'ATMS') }}
    </x-slot>
            ...
            <div class="p-8 bg-white border border-gray-200 rounded-lg shadow-lg">
                <form action="{{ route('batches.update', $batch->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="start_year" id="start_year" value="{{ $batch->start_year }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="end_year" id="end_year" value="{{ $batch->end_year }}"
                            class="w-full p-2 mt-1 transition duration-300 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                            required>
                    </div>
