...
<body class="bg-gradient-to-l from-blue-200 via-blue-200 to-blue-300">
    ...
    <nav
        ...
        <div class="flex items-center space-x-2">
            ...
            <div class="text-3xl font-bold text-blue-500">ATMS</div>
        </div>
        ...
        <div class="max-w-8xl mx-auto flex flex-col md:flex-row items-center gap-20">
            ...
            <div class="md:w-1/2 text-justify">
                ...
                <p class="text-gray-700 text-lg leading-relaxed mb-4">
                    The <span class="font-semibold text-blue-500">Automated Transport Management System (ATMS)</span>
                ...
                <p class="text-gray-700 text-lg leading-relaxed mb-4">
                    <strong>Say goodbye to manual logs and inefficiencies!</strong> ATMS ensures a <strong>smooth and
                ...
                <p class="text-gray-700 text-lg leading-relaxed">
                    Built with <strong>cutting-edge technology</strong>, ATMS is <strong>secure, scalable, and easy to
            ...
            <div class="md:w-1/2">
                <h3 class="text-2xl font-semibold text-gray-900 mb-4">🌟 Why Choose ATMS?</h3>
