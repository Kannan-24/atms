    ...
    <div class="py-6 mt-20 ml-4 sm:ml-64">
        <div class="w-full max-w-4xl px-6 mx-auto">
            ...
            <div class="p-8 bg-white border border-gray-200 rounded-lg shadow-lg">
                ...
                <div class="mb-4">
                    <h3 class="text-lg font-semibold">Faculty ID:</h3>
                    <p>{{ $faculty->ts_id }}</p>
                </div>
                <div class="mb-4">
                    <h3 class="text-lg font-semibold">Phone:</h3>
                    <p>{{ $faculty->user->phone }}</p>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <p>{{ $faculty->department->dept_name }} - {{ $faculty->department->dept_code }}</p>
                </div>
            </div>
        </div>
    </div>
