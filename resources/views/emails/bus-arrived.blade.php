...
<body>
    <div class="container">
        <div class="header">🚌 Upcoming Bus Arrival Alert</div>
        <div class="content">
            <p>Dear Students & Parent,</p>
            <p>The bus is approaching your designated stop and is currently 1.5 km away.</p>
            <div class="info-box">
            ...
            <p>Please be ready for pickup. For any queries, contact the driver.</p>
        </div>
